...
import { renderProgram } from "./program-view.js?v=f4-14";
import { renderMineList, renderPathsOverlay } from "./path-view.js?v=f4-9";
import { renderMappa } from "./mappa-view.js?v=f4-8";
import { renderCagliari, onCagliariVisible } from "./cagliari-view.js?v=f4-6";
import { renderCatalog, onCatalogVisible } from "./catalog-view.js?v=f4-7";
