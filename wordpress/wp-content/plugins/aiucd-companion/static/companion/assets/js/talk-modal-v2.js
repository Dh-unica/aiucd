...
import { AREA_BY_CODE, areaLabel } from "./data.js?v=f4-5";
import * as agenda from "./agenda.js";
import { showSingleEventMenu } from "./calendar-menu.js?v=f4-5";
import { t, getLang, translateRoom } from "./i18n.js?v=f4-5";
